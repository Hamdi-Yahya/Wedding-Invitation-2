...
@section('content')
    ...
    <div class="hero-wrapper">
        ...
        <!-- Hero section dengan nama mempelai dan foto -->
        <section class="hero-section">
            <div class="hero-container">
                ...
                <div class="hero-right">
                    @php
                        $heroImg = $gallery->firstWhere('label', 'hero') ?? $gallery->first();
                    @endphp
                    @if ($heroImg)
                        <img src="{{ asset($heroImg->image_url) }}" alt="{{ $heroImg->alt_text ?? 'Wedding Photo' }}"
                            class="hero-image" style="object-position: {{ $heroImg->object_position ?? 'center' }};">
                    @else
    ...
    <!-- Section RSVP untuk tamu umum (bukan personal) -->
            ...
            <div class="rsvp-card">
                ...
                <div class="rsvp-form">
                    <div class="form-group">
                        <label>NAMA</label>
                        <input type="text" id="rsvpName" placeholder="Nama lengkap Anda">
                    </div>
                    <div class="form-group">
                        <label>NOMOR HP</label>
                        <input type="tel" id="rsvpPhone" placeholder="Contoh: 08123456789" inputmode="numeric"
                    ...
                    <div class="form-group">
                        ...
                        <select id="rsvpStatus">
                            ...
                            <option value="Not Coming">Tidak Hadir</option>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <!-- Footer dengan inisial mempelai -->
    ...
    @push('scripts')
        <script>
            ...
            /* Mengirim data RSVP dan ucapan ke server via API */
            function submitRSVP() {
                ...
                fetch('/api/rsvp', {
                    ...
                    .then(function (res) {
                        ...
                        /* Redirect ke halaman undangan personal untuk mendapatkan QR Code */
                        if (res && res.guest && res.guest.slug) {
                            window.location.href = '/invite/' + res.guest.slug;
                        }
                    })
                    .catch(function (err) {
